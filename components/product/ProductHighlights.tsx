              ...
              return (
                <div class="absolute w-full left-0 top-0 p-[10px] flex items-center z-10">
                  <div class="w-full h-full z-10 grid grid-cols-2 gap-y-1">
                    <div
                      class={`product-highlights flex box-content h-[25px] text-[9px] 2xl:text-[10px] items-center uppercase font-bold border-none rounded-lg  bg-opacity-100 opacity-100 justify-center
                        ${
                        alignVertical
                        ...
                        ${
                        columnStart
                          ? GRID_COL_START[columnStart]
                          : "col-start-auto"
                      }
                        ${
                        alignHorizontal
                          ? GRID_ROW_HORIZONTAL[alignHorizontal]
                          : "items-center"
                      }  
                        ${icon ? "p-0 self-start" : "p-1 2xl:p-2 self-start"}
                        ${
                        widthElement
                          ? "w-" + WIDTH_ELEMENT[widthElement]
                          : "w-auto"
                      }
                      `}
                      style={{
                    ...
                    >
                      {icon
                        ? <Image src={icon} width={58} height={58} />
                        : label
                        ? label
                        : value}
                    </div>
